...
namespace Auth0.ManagementApi
{
    ...
    public class ManagementApiClient : IManagementApiClient
    {
        ...
        public ManagementApiClient(string token, Uri baseUri, DiagnosticsHeader diagnostics = null, ICredentials credentials = null, Uri proxyUri = null)
        {
            ...
            apiConnection = new ApiConnection(token, baseUri.AbsoluteUri, diagnostics, credentials, proxyUri);
        ...
        /// <param name="proxyUri">The proxy URI.</param>
        public ManagementApiClient(string token, Uri baseUri, ICredentials creds, Uri proxyUri)
            : this(token, baseUri, null, creds, proxyUri)
        {
        }
    }
}