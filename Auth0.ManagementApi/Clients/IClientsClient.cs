...
namespace Auth0.ManagementApi.Clients
{
    ...
    public interface IClientsClient
    {
        ...
        /// <returns></returns>
        Task<Auth0.Core.Client> CreateAsync(ClientCreateRequest request);
        ...
        /// </param>
        /// <returns></returns>
        Task<IList<Auth0.Core.Client>> GetAllAsync(string fields = null, bool includeFields = true);
        ...
        /// </param>
        /// <returns></returns>
        Task<Auth0.Core.Client> GetAsync(string id, string fields = null, bool includeFields = true);
        ...
        /// <returns></returns>
        Task<Auth0.Core.Client> UpdateAsync(string id, ClientUpdateRequest request);
...
#pragma warning disable 1591
        ...
        Task<Auth0.Core.Client> Create(ClientCreateRequest request);
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        Task<Auth0.Core.Client> Get(string id, string fields = null, bool includeFields = true);

        [Obsolete("Use GetAllAsync instead")]
        [EditorBrowsable(EditorBrowsableState.Never)]
        Task<IList<Auth0.Core.Client>> GetAll(string fields = null, bool includeFields = true);

        [Obsolete("Use UpdateAsync instead")]
        [EditorBrowsable(EditorBrowsableState.Never)]
        Task<Auth0.Core.Client> Update(string id, ClientUpdateRequest request);
