...
namespace Auth0.ManagementApi.Clients
{
    ...
    public class ClientsClient : ClientBase, IClientsClient
    {
        ...
        public Task<Auth0.Core.Client> CreateAsync(ClientCreateRequest request)
        {
            return Connection.PostAsync<Auth0.Core.Client>("clients", request, null, null, null, null, null);
        }
        ...
        /// true)</param>
        /// <returns>Task&lt;Core.Client&gt;.</returns>
        public Task<Auth0.Core.Client> GetAsync(string id, string fields = null, bool includeFields = true)
        {
            return Connection.GetAsync<Auth0.Core.Client>("clients/{id}",
        ...
        public Task<IList<Auth0.Core.Client>> GetAllAsync(string fields = null, bool includeFields = true)
        {
            return Connection.GetAsync<IList<Auth0.Core.Client>>("clients", null,
                new Dictionary<string, string>
                {
                    {"fields", fields},
                    {"include_fields", includeFields.ToString().ToLower()}
        ...
        /// <returns>Task&lt;Core.Client&gt;.</returns>
        public Task<Auth0.Core.Client> UpdateAsync(string id, ClientUpdateRequest request)
        {
            return Connection.PatchAsync<Auth0.Core.Client>("clients/{id}", request, new Dictionary<string, string>
            {
                {"id", id}
            });
        }
...
#pragma warning disable 1591
        ...
        public Task<Auth0.Core.Client> Create(ClientCreateRequest request)
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public Task<Auth0.Core.Client> Get(string id, string fields = null, bool includeFields = true)
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public Task<IList<Auth0.Core.Client>> GetAll(string fields = null, bool includeFields = true)
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public Task<Auth0.Core.Client> Update(string id, ClientUpdateRequest request)
        {
